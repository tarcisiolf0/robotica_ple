...
% Matriz de Transformação Homogênea calculada através da Composição de Transformações
...
% Nesse exemplo, tf1=base_link, Matriz de Transformação Homogênea inversa
% de link6 em relação a base_link
% B_T_A = A_T_B^-1
link6_T_tf1_comp = inv(base_link_T_link6);
