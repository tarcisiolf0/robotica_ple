...
T_b_1 = translationz(dh(1,1))*rotationz(dh(1,2));
T_1_2 = translationz(dh(2,1))*rotationy(-dh(2,1));
T_2_3 = translationz(dh(3,1))*rotationy(-dh(3,1));
T_3_4 = translationx(dh(4,1))*rotationz(dh(4,2));
T_4_5 = translationz(dh(5,1))*rotationy(-dh(5,1));
T_5_6 = translationz(dh(6,1))*rotationz(dh(6,2));
