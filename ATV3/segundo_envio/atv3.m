...
'Comparação das matrizes de transformação homogêneas do Rviz e da matriz dh'
base_link_T_link1
base_link_T_link1_dh = double(subs(base_link_T_link1_dh, {theta1}, {0}))
link1_T_link2
link1_T_link2_dh = double(subs(link1_T_link2_dh, {theta2}, {0}))
link2_T_link3
link2_T_link3_dh = double(subs(link2_T_link3_dh, {theta3}, {0}))
link3_T_link4
link3_T_link4_dh = double(subs(link3_T_link4_dh, {theta4}, {0}))
link4_T_link5
link4_T_link5_dh = double(subs(link4_T_link5_dh, {theta5}, {0}))
link5_T_link6
link5_T_link6_dh = double(subs(link5_T_link6_dh, {theta6}, {0}))